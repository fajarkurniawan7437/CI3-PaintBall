                ...
                <ul class="navbar-nav ms-auto mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            ...
                            <li><a class="dropdown-item" href="<?= base_url('user/change_profile'); ?>">Edit Profile</a></li>
                            <li><a class="dropdown-item" href="<?= base_url('user/change_password'); ?>">Change Password</a></li>
